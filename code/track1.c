...
void track1_init(Track1Scene* scene, rdpq_font_t* font, const GameState* state) {
    ...
    scene->track_model = t3d_model_load("rom:/scene_race.t3dm");
    ...
    carmovement_init(&scene->car_movement, (T3DVec3){{0.0f, 0.0f, 0.0f}}, 15.0f);
...
void track1_render(Track1Scene* scene) {
    ...
    t3d_screen_clear_color(RGBA32(30, 30, 60, 0xFF));
    ...
    rdpq_sync_pipe();
    rdpq_text_printf(NULL, 10, 16, 16, "TRACK 1");
